...
python3 scripts/run_benchmark.py --map site/data/cambridge-photo-informed-map.json --k 6 --objective capture_prob --mc-runs 140 --time-horizon-steps 48 --seed 7 --baseline-mode heuristic --baseline-samples 40
